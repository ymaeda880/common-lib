# -*- coding: utf-8 -*-
# common_lib/busy/apply_embedding_result.py
# ============================================================
# busy 反映ユーティリティ（Embedding 正本）
#
# 目的：
# - EmbedResult（res）から cost を「返ってきた範囲だけ」取り出し、
#   busy_run（br）へ反映する
...
class AppliedEmbeddingPostprocess:
    cost_obj: Any
    note: str = ""
...
# ============================================================
# 正本：EmbedResult → busy_run(br) 反映
# ============================================================
def apply_embedding_result_to_busy(
    *,
    br: Any,
    res: Any,
    note_ok_cost: str = "ok_cost",
    note_no_cost: str = "no_cost",
) -> AppliedEmbeddingPostprocess:
    """
    ...
    return AppliedEmbeddingPostprocess(
        cost_obj=cost_obj,
        note=str(note),
    )
