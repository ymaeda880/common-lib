...
GPT_OCR_PROMPT = (
    "この画像に実際に含まれている文字だけを、できるだけ忠実にすべて抽出してください。\n"
    "表・箇条書き・改行は、可能な範囲で元の構造を保ってください。\n"
    "判読できない文字は推測や補完をせず、読める文字だけを出力してください。\n"
    "出力にはOCRで読み取った本文だけを含めてください。\n"
    "説明、要約、前置き、後書き、注釈、注意書き、括弧書きは一切追加しないでください。\n"
    "「判読できない」「補完していない」「忠実に転記した」など、"
    "OCR処理そのものについての説明は一切出力しないでください。"
)
