...
def transcribe_audio(
    *,
    ...
    #             # タイムスタンプ精度
    #             # --------------------------------------------------------
    #             "各字幕の開始時刻は、その字幕の最初の発話音声が実際に始まった時刻にしてください。",
    #             "開始時刻は、文章の意味、文の区切り、字幕としての読みやすさから推測しないでください。",
    #             "開始時刻を読みやすさのために前後へ移動させないでください。",
    #             "短い発話、相づち、挨拶についても、実際にその発話が始まった時刻を使用してください。",
    #             "話者が交代した場合は、新しい話者が実際に発話を開始した時刻を開始時刻にしてください。",
    #             "タイムスタンプの正確さを、字幕の読みやすさより優先してください。",
    #             "音声の先頭を 00:00:00,000 としてください。",
